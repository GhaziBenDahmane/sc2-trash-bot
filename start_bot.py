...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='Run a game against external server')
    parser.add_argument('--master', action='store_true',
                        help='this is the master (creates the game)')
    ...
    parser.add_argument('--step-time-limit', nargs=1, default=None,
                        help="Max seconds per step (realtime seconds)")
    parser.add_argument('--game-time-limit', nargs=1, default=None,
                        help="Max seconds per game (gametime seconds)")
